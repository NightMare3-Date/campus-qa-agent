...
# FAISS C++ 库不支持含中文的路径，因此使用纯 ASCII 路径

CHROMA_DIR = os.path.join(

    os.environ.get("CHROMA_DB_DIR", "C:/aiagent_chroma_db"),
...
class CampusRAG:
    ...
    def __init__(self, knowledge_dir: Optional[str] = None):
        ...
        self.knowledge_dir = str(knowledge_dir or os.environ.get("KNOWLEDGE_DIR", os.path.join(BASE, "knowledge")))
